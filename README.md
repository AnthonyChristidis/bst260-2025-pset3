# Problem Set 3: Data Wrangling, Visualization, and Statistical Analysis with tidyverse
...
-   Attend office hours for coding and statistical analysis help
...
|:-------------|:-------------|:-------------|:-------------|:----------------|
| **tidyverse Proficiency & Pipe Usage (25 points)** | 23-25: Perfect use of single pipe chains, efficient tidyverse operations, no intermediate variables. Demonstrates mastery of dplyr/tidyr workflow. | 20-22: Good pipe usage with minor inefficiencies. Most operations properly chained together. | 15-19: Some proper pipe usage but creates unnecessary intermediate variables or inefficient operations. | 0-14: Poor pipe usage, creates many intermediate variables, doesn't follow single-pipe constraint. |
| **Data Analysis & Statistical Concepts (25 points)** | 23-25: Excellent understanding of confounders, proper confidence interval calculations, correct statistical interpretations. Insightful analysis of health disparities. | 20-22: Good statistical analysis with minor errors in calculations or interpretations. | 15-19: Basic statistical analysis but misses some key concepts or has calculation errors. | 0-14: Poor statistical understanding, major errors in confidence intervals or confounder analysis. |
...
| **Code Organization & Documentation (10 points)** | 9-10: Exceptionally clean, well-commented code. Clear logic flow, excellent variable naming, easy to follow. | 8: Good code organization with minor documentation gaps. Code is readable and well-structured. | 6-7: Basic code organization but some unclear sections or missing comments where needed. | 0-5: Poor code organization, unclear logic, missing documentation, or difficult to follow. |
...
3.  **Correct statistical calculations**: Confidence intervals, group comparisons, confounder analysis
...
6.  **Statistical interpretation**: Understanding of age, BMI, and smoking as confounders
...
This rubric emphasizes the **data wrangling skills** and **statistical thinking** essential for modern data science workflows.
